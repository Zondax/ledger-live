import { MINA_DECIMALS, MINA_SYMBOL, MINA_TOKEN_ID, NETWORK_IDENTIFIER } from "../../consts";

// Types for better type safety
type NetworkIdentifier = typeof NETWORK_IDENTIFIER;
type Address = string;
...
/**
 * Adds network identifier to the provided data
 * @param data - The data to add network identifier to
 * @returns Data with network identifier
 */
