...
const AccountBalanceSummaryFooter: MinaFamily["AccountBalanceSummaryFooter"] = ({ account }) => {
  ...
  const stakedBalance = formatCurrencyUnit(
    unit,
    BigNumber(15.98235).multipliedBy(10 ** unit.magnitude),
    {
      discreet,
      locale,
      showCode: true,
    ...
    <Wrapper>
      <DetailsWrapper>
        <BalanceDetail>
          ...
          <AmountValue>Auro Wallet</AmountValue>
        </BalanceDetail>
        ...
        <BalanceDetail>
          <ToolTip content="Public address of the block producer">
            <TitleWrapper>
              <Title>Producer Address</Title>
              <InfoCircle size={13} />
            </TitleWrapper>
          </ToolTip>
          <AddressText>B62q3TQ8A...jfTPTKDBW6</AddressText>
        </BalanceDetail>
      </DetailsWrapper>
    </Wrapper>
  );
