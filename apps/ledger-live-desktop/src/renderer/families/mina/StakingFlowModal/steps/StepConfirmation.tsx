  ...
  if (optimisticOperation) {
    return (
      <Container>
        ...
        <SuccessDisplay
          title="Delegation successfully completed"
          description="Your delegation request has been confirmed. You can now view the details of your delegation in your account."
        />
      </Container>
    );
  }
  ...
  if (error) {
    return (
      <Container shouldSpace={signed}>
        ...
        />
        {signed ? (
          <BroadcastErrorDisclaimer title="An error occurred while broadcasting the transaction" />
        ) : null}
  ...
  return (
    <Box horizontal alignItems="right">
      ...
      {concernedOperation ? (
        ...
        >
          <Trans i18nKey="mina.stake.flow.steps.confirmation.success.cta" />
        </Button>
      ) : error ? (
